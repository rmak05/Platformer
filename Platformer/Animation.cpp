...
Animation::Animation(const std::string _name, const sf::Texture& _texture, const float _scale_x, const float _scale_y, const unsigned _num_rows, const unsigned _num_columns, const unsigned _duration) {
    name            = _name;
    size            = sf::Vector2u(_num_columns, _num_rows);
    sprite_count    = _num_rows * _num_columns;
    duration        = _duration;
    curr_frame      = sprite_count * duration - 1;
